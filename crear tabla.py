...
def correlation(data):
    cols = ['Button1_Value','Button2_Value','Button3_Value','Button4_Value','Button5_Value','Button6_Value','Button7_Value','Button8_Value','Button9_Value','Button10_Value','Button11_Value','Button12_Value','Button13_Value']
...
graficamedias(data,date)
data=filtraryjuntar(data,date)
